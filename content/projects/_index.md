...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 10px;">
  <a href="/my-web-app.md" class="project-button">Project Proposal</a>
  <a href="/my-web-app-2.md" class="project-button">Knowledge Base</a>
  <a href="/my-web-app-3.md" class="project-button">Figma Prototype</a>
  <a href="/my-web-app-44.md" class="project-button">Excalidraw</a>
  <a href="/my-web-app-5.md" class="project-button">Product Synthesis</a>
  <a href="/my-web-app-6.md" class="project-button">Product Prototype 
  </div>
